...
// PATCH B: tutup Kolom 1, Kolom 2 (Dept Head, penuh), buka Kolom 3
...
if (!check(block, oldB, "B: Tutup Kolom1 + Kolom2 penuh + Buka Kolom3")) allOk = false;

// PATCH C: tutup Kolom 3, buka Kolom 4
...
if (!check(block, oldC, "C: Tutup Kolom3 + Buka Kolom4")) allOk = false;

// PATCH D: tutup Kolom 4 (terakhir)
...
if (!check(block, oldD, "D: Tutup Kolom4 (terakhir)")) allOk = false;
