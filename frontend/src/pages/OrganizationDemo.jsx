      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
          ...
          <p className="text-lg text-gray-600 mb-6">
            Solusi lengkap untuk masalah struktur organisasi yang fleksibel
            dengan connector melengkung dan drag & drop bebas.
          </p>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-white rounded-lg p-4 border border-red-200">
                  ...
                  <ul className="text-red-600 text-sm space-y-1">
                    ...
                    <li>
                      • Posisi box tidak bisa disesuaikan dengan keinginan
                    </li>
                ...
                <div className="bg-white rounded-lg p-4 border border-red-200">
                  ...
                  <ul className="text-red-600 text-sm space-y-1">
                    <li>
                      • Structure organisasi sangat mungkin berubah
                      sewaktu-waktu
                    </li>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div className="p-4 border border-blue-200 rounded-lg">
                  ...
                  <p className="text-gray-600 text-sm">
                    Line connector otomatis melengkung dengan algoritma Bezier
                    curve. Mendukung berbagai style: curved, stepped,
                    orthogonal.
                  </p>
                </div>
                ...
                <div className="p-4 border border-green-200 rounded-lg">
                  ...
                  <p className="text-gray-600 text-sm">
                    Drag & drop bebas tanpa batasan grid. Posisikan box di
                    manapun sesuai kebutuhan struktur organisasi Anda.
                  </p>
                </div>
                ...
                <div className="p-4 border border-purple-200 rounded-lg">
                  ...
                  <p className="text-gray-600 text-sm">
                    Navigate chart yang besar dengan mudah. Zoom in untuk
                    detail, zoom out untuk overview keseluruhan.
                  </p>
                </div>
                ...
                <div className="p-4 border border-red-200 rounded-lg">
                  ...
                  <p className="text-gray-600 text-sm">
                    Semua perubahan otomatis tersimpan. Export ke PDF, PNG, atau
                    JSON untuk backup dan sharing.
                  </p>
                </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
              ...
              <ol className="text-yellow-700 space-y-2">
                <li>
                  <strong>1.</strong> Buka Dashboard Editor yang sudah ada
                </li>
                <li>
                  <strong>2.</strong> Klik tombol "🚀 Advanced Editor" di bagian
                  atas
                </li>
                <li>
                  <strong>3.</strong> Atau akses langsung di URL:{" "}
                  <code>/dashboard-editor-advanced</code>
                </li>
                <li>
                  <strong>4.</strong> Pilih engine: React Flow atau D3.js
                </li>
                <li>
                  <strong>5.</strong> Aktifkan Edit Mode dan mulai berkreasi!
                </li>
              </ol>
            </div>
          </div>
        ...
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg p-6 text-center">
          ...
          <p className="text-blue-100 mb-6">
            Semua fitur sudah terintegrasi dengan sistem yang ada. Tidak merusak
            data yang sudah ada dan backward compatible dengan editor klasik.
          </p>
