            ...
            <div className="space-y-4 flex flex-col items-center">
              <div className="bg-white border border-gray-400 rounded shadow-sm flex min-h-[100px] w-[240px]">
                ...
                <div className="p-2 flex-1 text-center flex flex-col justify-center">
                  ...
                  <p className="text-xs leading-tight uppercase">(23060056)</p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4 flex flex-col items-center">
              <div className="bg-white border border-gray-400 rounded shadow-sm flex min-h-[100px] w-[240px]">
                ...
                <div className="p-2 flex-1 text-center flex flex-col justify-center">
                  ...
                  <hr className="my-1 border-gray-300" />
                  <p className="text-xs leading-tight uppercase">YEREMIA SOFYA</p>
                  <p className="text-xs leading-tight uppercase">(23240195)</p>
                  <hr className="my-1 border-gray-300" />
                  <p className="text-xs leading-tight uppercase">ASEP AGUNG WIGUNA</p>
                  <p className="text-xs leading-tight uppercase">(23180195)</p>
                </div>
              </div>
              ...
              <div className="bg-white border border-gray-400 rounded shadow-sm flex min-h-[100px] w-[240px]">
                <div className="bg-gray-100 p-1 text-center border-r border-gray-400 w-16 flex items-center justify-center">
                  <p className="text-xs font-bold uppercase">PRD2.5</p>
                </div>
                <div className="p-2 flex-1 text-center flex flex-col justify-center">
                  <p className="text-xs font-semibold mb-1 leading-tight uppercase">QUALITY ASSURANCE</p>
                  <hr className="my-1 border-gray-300" />
                  <p className="text-xs leading-tight uppercase">ACHYIA SATIAWA</p>
                  <p className="text-xs leading-tight uppercase">SURVADALTA (23240091)</p>
                </div>
              </div>
              ...
              <div className="bg-white border border-gray-400 rounded shadow-sm flex min-h-[100px] w-[240px]">
                <div className="bg-gray-100 p-1 text-center border-r border-gray-400 w-16 flex items-center justify-center">
                  <p className="text-xs font-bold uppercase">PRD2.6</p>
                </div>
                <div className="p-2 flex-1 text-center flex flex-col justify-center">
            ...
            <div className="space-y-4 flex flex-col items-center">
              <div className="bg-white border border-gray-400 rounded shadow-sm flex min-h-[200px] w-[240px]">
                ...
                <div className="p-2 flex-1 text-center flex flex-col justify-center">
                  ...
                  <hr className="my-1 border-gray-300" />
                  <p className="text-xs leading-tight uppercase">MUH NAADER</p>
                  <p className="text-xs leading-tight uppercase">(23120193)</p>
                  <hr className="my-1 border-gray-300" />
                  <p className="text-xs leading-tight uppercase">GUNYHANTO</p>
                  <p className="text-xs leading-tight uppercase">(23120195)</p>
                  <hr className="my-1 border-gray-300" />
              ...
              <div className="bg-white border border-gray-400 rounded shadow-sm flex min-h-[180px] w-[240px]">
                ...
                <div className="p-2 flex-1 text-center flex flex-col justify-center">
                  ...
                  <p className="text-xs leading-tight uppercase">(23240128)</p>
                </div>
              </div>
              ...
              <div className="bg-white border border-gray-400 rounded shadow-sm flex min-h-[220px] w-[240px]">
                ...
                <div className="p-2 flex-1 text-center flex flex-col justify-center">
                  ...
                  <hr className="my-1 border-gray-300" />
                  <p className="text-xs leading-tight uppercase">AINA WAKHIIDAH</p>
                  ...
                  <hr className="my-1 border-gray-300" />
                  <p className="text-xs leading-tight uppercase">M. YUNUS AFIFAI</p>
                  <p className="text-xs leading-tight uppercase">(23120192)</p>
                  <hr className="my-1 border-gray-300" />
                  <p className="text-xs leading-tight uppercase">DODIK</p>
                  <p className="text-xs leading-tight uppercase">(23120192)</p>
                  <hr className="my-1 border-gray-300" />
                  <p className="text-xs leading-tight uppercase">NACA ROBIANA HENDRAYANA</p>
              ...
              <div className="bg-white border border-gray-400 rounded shadow-sm flex min-h-[80px] w-[240px]">
                <div className="bg-gray-100 p-1 text-center border-r border-gray-400 w-16 flex items-center justify-center">
                  <p className="text-xs font-bold uppercase">PRD2.4</p>
                </div>
                <div className="p-2 flex-1 text-center flex flex-col justify-center">
