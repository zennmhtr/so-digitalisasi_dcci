        ...
        <div className="min-w-[1000px] relative p-4 print:min-w-0 print:p-0">
          ...
          <div className="grid grid-cols-4 gap-4 relative org-grid" style={{ zIndex: 2 }}>
            ...
            <div className="space-y-4 flex flex-col items-center">
              <div className="bg-white border border-gray-400 rounded shadow-sm flex min-h-[120px] w-[280px]">
                <div className="bg-gray-100 p-2 text-center border-r border-gray-400 w-20 flex items-center justify-center">
                  <p className="text-sm font-bold">MIO1.0</p>
                </div>
                <div className="p-3 flex-1 text-center flex flex-col justify-center">
                  <p className="text-sm font-semibold mb-2 leading-tight">MI & SHE (5R-SMK3-ISO 14001)</p>
                  <hr className="my-2 border-gray-300" />
                  <p className="text-sm leading-tight">ELIATA DUMAR GINTING</p>
                    <p className="text-sm leading-tight">(23190806)</p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4 flex flex-col items-center">
              <div className="bg-white border border-gray-400 rounded shadow-sm flex min-h-[120px] w-[280px]">
                <div className="bg-gray-100 p-2 text-center border-r border-gray-400 w-20 flex items-center justify-center">
                  <p className="text-sm font-bold">MIO1.1</p>
                </div>
                <div className="p-3 flex-1 text-center flex flex-col justify-center">
                  <p className="text-sm font-semibold mb-2 leading-tight whitespace-nowrap">MI</p>
                  <hr className="my-2 border-gray-300" />
              ...
              <div className="bg-white border border-gray-400 rounded shadow-sm min-h-[180px] w-[280px]">
                <div className="flex flex-col h-full">
                  <div className="flex border-b border-gray-400">
                    <div className="bg-gray-100 p-2 text-center border-r border-gray-400 w-20 flex items-center justify-center">
                      <p className="text-sm font-bold">MIO1.2</p>
                    </div>
                    <div className="p-2 flex-1 text-center bg-gray-100">
                      <p className="text-sm font-semibold leading-tight">SHE (5R-SMK3-ISO 14001)</p>
                    </div>
                  </div>
                  
                  {[
                    { name: "AFKA FIKRI AIMAN (COORD)", nip: "(23230122)" },
                    { name: "TARJO", nip: "(23090096)" },
                    { name: "ZEL UWEYS A.A.A.S.A", nip: "(23120171)" },
                  ].map((staff, i) => (
                    <div 
                      key={i} 
                      className={`p-3 text-center border-b border-gray-300 flex-1 ${i === 2 ? 'border-b-0' : ''}`}
                    >
